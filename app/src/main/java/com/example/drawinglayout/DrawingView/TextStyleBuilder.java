...
public class TextStyleBuilder {
    ...
    /**
     * Enum to maintain current supported style properties used on on {@link (String, TextStyleBuilder)} and {@link PhotoEditor#editText(View, String, TextStyleBuilder)}
     */
