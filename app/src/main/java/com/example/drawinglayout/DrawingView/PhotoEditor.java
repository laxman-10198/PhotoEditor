...
import com.example.drawinglayout.Interface.BrushViewChangeListener;
...
public class PhotoEditor implements BrushViewChangeListener {
    ...
    public void saveAsFile(@NonNull final String imagePath, @NonNull final OnSaveListener onSaveListener) {
        saveAsFile(imagePath, new SaveSetting.Builder().build(), onSaveListener);
    }
     ...
     *
     * @param imagePath      path on which image to be saved
     * @param saveSettings   builder for multiple save options {@link SaveSetting}
     * @param onSaveListener callback for saving image
     * @see OnSaveListener
     */
    ...
    public void saveAsFile(@NonNull final String imagePath,
                           @NonNull final SaveSetting saveSettings,
    ...
    public void saveAsBitmap(@NonNull final OnSaveBitmap onSaveBitmap) {
        saveAsBitmap(new SaveSetting.Builder().build(), onSaveBitmap);
    }
     ...
     */
    @SuppressLint("StaticFieldLeak")
    public void saveAsBitmap(@NonNull final SaveSetting saveSettings,
